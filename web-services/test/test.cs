...
internal class Program
{
    static void Main()
    {
        Console.WriteLine("Content-type: text/html\n"); var allvars = Environment.GetEnvironmentVariables(); var dict = new Dictionary<string, string>();
        ...
        foreach (var record in dict.OrderBy(d => d.Key))
            Console.WriteLine("<tr><td>" + record.Key + "</td><td>" + ((record.Key.Contains("PASS") || record.Key.Contains("CONN_STRING")) ? "" : record.Value) + "</td></tr>\n");
