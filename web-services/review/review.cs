...
class Program
{
    ...
    static void Main()
    {
        ...
        sendresponse(project, onlycat, cat, "<iframe src=\"https://" + project + ".org/w/index.php?title=Навальный,_Алексей_Анатольевич&diff=" + currid + "&oldid=" + oldid + "\" height=1000 width=90%></iframe>");
    }
}
