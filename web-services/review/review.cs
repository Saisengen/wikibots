...
class Program
{
    ...
    static void Main()
    {
        ...
        sendresponse(project, onlycat, cat, "<iframe src=\"https://" + project + ".org/w/index.php?title=Навальный,_Алексей_Анатольевич&diff=150192639&oldid=150185506\" height=1000 width=90%></iframe>");
    }
}
