...
class Program
{
    ...
    static void Main()
    {
        ...
        sendresponse(project, onlycat, cat, "<iframe src=\"https://" + project + ".org/w/index.php?title=Навальный,_Алексей_Анатольевич&oldid=150192639\" height=1000 width=90%></iframe>");
    }
}
