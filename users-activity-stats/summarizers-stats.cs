...
class Program
{
    ...
    static void Main()
    {
        ...
        var first_not_fully_summaried_year = new Dictionary<string, int>
        {
            ...
            { "Кандидаты в добротные статьи", 0 },{ "Кандидаты в избранные списки и порталы", 0 },{ "Заявки на статус патрулирующего", 0 },{ "Заявки на статус подводящего итоги", 0 },{ "Заявки на статус автопатрулируемого", 0 },
        };
        ...
        string common_resulttext = "{{Плавающая шапка таблицы}}{{shortcut|ВП:ИТОГИ}}{{clear}}<center>{{самые активные участники}}\nСтатистика по числу итогов, подведённых %type%. См. также %otherpage%.\n\n" +
            ...
            "{{abbr|<big>🗑⇧</big>|ВУС|0}}!!{{abbr|📄<big>⇨</big>|КПМ|0}}!!{{abbr|<big>⇨⇦⇨</big>|КОБ+КРАЗД|0}}!!{{abbr|<big>𓊍</big>|ОБК|0}}!!{{abbr|📄⇧|КУЛ|0}}!!{{abbr|🔨|ЗКА|0}}!!" +
